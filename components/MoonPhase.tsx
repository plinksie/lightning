...
export default function MoonPhase({ selectedLocation, lat, lon, isDarkMode }: MoonPhaseProps) {
  ...
  return (
    <div className={`absolute bottom-4 left-4 ${isDarkMode ? 'bg-gray-800 text-white' : 'bg-white text-gray-800'} p-4 rounded-lg shadow-lg`}>
