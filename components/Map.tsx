...
function MapContent({
  ...
  useEffect(() => {
    ...
    lightningData.forEach((strike: any) => {
      ...
      marker.bindPopup(
        `Lightning strike at ${strike.coord.lat}, ${strike.coord.lon}`
      );
      ...
      const animate = () => {
        ...
        ripple.setStyle({
          opacity: ripple.options.opacity! - 0.01,
          fillOpacity: ripple.options.fillOpacity! - 0.01,
        });
      ...
      const line = L.polyline(
        [
          [strike.coord.lat, strike.coord.lon],
          [strike.coord.lat, strike.coord.lon],
        ],
        {
          color: "yellow",
